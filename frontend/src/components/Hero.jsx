                    ...
                    >
                        <div className="main-intro">
                            <h1 className="hero-title">
                                I'm <span className="highlight">Hemanth G</span>
                            </h1>
                            ...
                            <div className="social-links">
                                ...
                                <div className="social-icons">
                                    <a href="https://github.com/Hemanth-205" target="_blank" rel="noopener noreferrer" className="social-icon">
                                    ...
                                    <a href="https://www.linkedin.com/in/hemanth-g25" target="_blank" rel="noopener noreferrer" className="social-icon"><Linkedin size={20} /></a>
                                    <a href="mailto:grhemanth26@gmail.com" className="social-icon">
